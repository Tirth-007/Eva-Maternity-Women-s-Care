...
//           We provide complete women’s health care with clarity, patience,
...
//             </h2>
//             <p className="mt-2">
//               Care for menstrual issues, hormonal concerns, infections,
//               and routine gynecological checkups.
//             </p>
//             <p className="mt-1 text-sm text-gray-600">
//               When to consult: irregular periods, pain, discomfort, or
...
//             </h2>
//             <p className="mt-2">
//               Complete pregnancy care from the first visit through delivery,
//               with guidance at every stage.
//             </p>
//             <p className="mt-1 text-sm text-gray-600">
//               Includes antenatal care, delivery planning, and post-delivery support.
//             </p>
//           </div>
...
//           <div>
//             <h2 className="text-xl font-semibold text-gray-900">
//               Infertility Guidance & Treatment
//             </h2>
//             <p className="mt-2">
//               Support and medical guidance for couples facing difficulty
//               in conceiving.
//             </p>
//             <p className="mt-1 text-sm text-gray-600">
//               Evaluation, counselling, and appropriate treatment options explained clearly.
//             </p>
//           </div>
...
//             </p>
//             <p className="mt-1 text-sm text-gray-600">
//               Procedures are discussed in detail before any decision is made.
//             </p>
//           </div>
...
//           <div>
//             <h2 className="text-xl font-semibold text-gray-900">
//               Preventive Checkups & Counseling
//             </h2>
//             <p className="mt-2">
//               Routine health checkups and guidance to help women
//               understand and manage their health better.
//             </p>
//             <p className="mt-1 text-sm text-gray-600">
//               Early consultation helps prevent future complications.
//             </p>
//           </div>
...
//             If you are unsure which service you need, you can start by talking to us.
//           </p>
